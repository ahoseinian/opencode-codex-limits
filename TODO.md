...
- [x] Implement a Codex usage client that fetches the current quota snapshot.
- [x] Normalize API data into a small internal quota model.
- [x] Render primary/5-hour quota usage in the sidebar.
